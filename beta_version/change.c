...
void change_status()
{
    ...
    if (found)
    {
        ...
        if (strcmp(selection, "1") == 0 || tolower(selection[0]) == 'a' || strcmp(selection, "activate") == 0||strcmp(selection, "Activate") == 0)
            wants_activate = 1;
        else if (strcmp(selection, "2") == 0 || tolower(selection[0]) == 'd' || strcmp(selection, "deactivate") == 0||strcmp(selection, "Deactivate") == 0)
            wants_deactivate = 1;
        else
        {
